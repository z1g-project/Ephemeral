...
const navigationMenuTriggerStyle = cva(
	"group inline-flex h-10 w-max items-center justify-center rounded-md px-4 py-2 text-sm text-slate-200 font-medium transition-colors focus:outline-none disabled:pointer-events-none disabled:opacity-50 bg-slate-950 hover:bg-slate-800 hover:text-slate-50 focus:bg-slate-800 focus:text-slate-50 data-[active]:bg-slate-800/50 data-[state=open]:bg-slate-800/50",
);
